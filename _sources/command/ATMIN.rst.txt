...
ATMIN
=====
The :ref:`ATMIN` command allows you to select a single row based on a minimum value of a defined column. Note that the column is treated as a number by default, to do a string comparison use the ``-s`` option.
