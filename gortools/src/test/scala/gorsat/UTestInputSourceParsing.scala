...
class UTestInputSourceParsing extends AnyFunSuite with BeforeAndAfter with MockitoSugar {
  ...
  test("Input Source: NOR") {
    ...
    testsToPerform += TestEntry(inputSourceName, "", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, singleColumnsPath.toString + " -h -r -asdict", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, singleColumnsPath.toString + " -f PN1,PN2,PN3", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, singleColumnsPath.toString + " -f", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, singleColumnsPath.toString + " -ff", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, singleColumnsPath.toString + " -ff " + singleColumnsPath, testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, "<(nor " + singleColumnsPath.toString + ")", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, "<(gor " + singleColumnsPath.toString + ")", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, "<(cmd " + singleColumnsPath.toString + ")", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, "<(" + singleColumnsPath.toString + ")", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, "<(" + singleColumnsPath.toString + ")asd", testShouldSucceed = false)
  ...
  test("Input Source: GOR") {
    ...
    testsToPerform += TestEntry(inputSourceName, "", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -stdin -nf -fs -w -Y -g -q", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -stdin -nf -fs -w -Y -g -j -q", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -b", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -b -10", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -b 10", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -seek", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -seek chr1", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -seek chr1:10-10-10", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -seek chr1:10-10", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -seek chr1:10", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -p", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -p chr1", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -p chr1:10-10", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -p chr1:10", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -p chr1:-10-100", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + ") -parts", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + ") -parts -10", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + ") -parts 10", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + ") -parts 10 -f", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + ") -parts 10 -f PN1,PN2,PN3", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + " -f #{tags}) -parts 10 -f PN1,PN2,PN3", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + ") -parts 10 -seek", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + ") -parts 10 -seek chr1:1000", testShouldSucceed = true)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + ") -parts 10 -p", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, "<(" + patientsPathSNP.toString + ") -parts 10 -p chr1:1000-2000", testShouldSucceed = true)

    // Legacy stuff
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -pchr1:10", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -pchr1:10 -Zksjdflkjlkjlkjlkljk", testShouldSucceed = false)
    testsToPerform += TestEntry(inputSourceName, patientsPathSNP.toString + " -p chr1:10 -Z ksjdflkjlkjlkjlkljk -H 1", testShouldSucceed = true)
  ...
  def createTestDataBase_Derby: Array[String] = {
    Class.forName("org.apache.derby.jdbc.EmbeddedDriver")
    val tmpDirectory = Files.createTempDirectory("inputsourceparsing").toFile
