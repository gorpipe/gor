...
@CommandLine.Command(name = "link",
        description = "Manage link files (create, update, updateMeta, resolve, rollback, list).",
        header = "Link file management commands.",
        subcommands = {LinkUpdateCommand.class, LinkUpdateMetaCommand.class, LinkRollbackCommand.class, LinkResolveCommand.class, LinkListCommand.class})
