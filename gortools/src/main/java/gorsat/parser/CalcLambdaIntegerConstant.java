...
public class CalcLambdaIntegerConstant extends CalcLambdaNumeric implements IntegerType, Constant {
    ...
    public TypedCalcLambda add(long other) {
        return new CalcLambdaLongConstant(value + other);
    }

    @Override
    public TypedCalcLambda add(double other) {
        return new CalcLambdaDoubleConstant(value + other);
    }
    ...
    public TypedCalcLambda add(CalcLambdaInteger other) {
        return new CalcLambdaInteger(cvp -> value + other.evaluateInt(cvp));
    }
    ...
    public TypedCalcLambda pow(TypedCalcLambda o) {
        ...
        if (other instanceof CalcLambdaIntegerConstant) {
            value = (int) Math.pow(value, other.evaluateInt(null));
            return this;
        }

        if (other instanceof CalcLambdaLongConstant) {
            return new CalcLambdaLongConstant((long) Math.pow(value, other.evaluateLong(null)));
        }
