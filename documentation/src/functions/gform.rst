...
The **form** function formats a number, specifying the space and decimals (C-style %x.yg format style). It either uses
the 'f' or 'e' notation depending on the size of the number and the number of decimal places specified.
