...
public class FileSource implements StreamSource {
    ...
    public StreamSourceMetadata getSourceMetadata() throws IOException {
        ...
        return new StreamSourceMetadata(this, "file://" + ffile.getCanonicalPath(), ffile.lastModified(), Files.getLastModifiedTime(file, LinkOption.NOFOLLOW_LINKS).toMillis(), ffile.length(), uniqueId, isSubset);
    }
