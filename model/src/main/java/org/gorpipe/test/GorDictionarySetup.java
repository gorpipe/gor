...
public class GorDictionarySetup {
     ...
     * @return array with paths to files created.
     */
    public static List<String> createDataFilesList(String name, Path path, int fileCount, int[] chrs, int rowsPerChr, String sourceColumn, boolean oneSourcePerFile, String[] sources) throws IOException {
        return createDataFilesMap(name, path, fileCount, chrs, rowsPerChr, sourceColumn, oneSourcePerFile, sources, false).values()
    ...
    public static Map<String, List<String>> createDataFilesMap(String name, Path path, int fileCount, int[] chrs, int rowsPerChr, String sourceColumn,
                                                               boolean oneSourcePerFile, String[] sources, boolean writeFileToJoinWith) throws IOException {
        return createDataFilesMap(name, path, fileCount, chrs, rowsPerChr, sourceColumn, oneSourcePerFile, sources, true, writeFileToJoinWith, 0);
    }
