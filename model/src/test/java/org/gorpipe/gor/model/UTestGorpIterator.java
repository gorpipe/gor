...
public class UTestGorpIterator {
    ...
    public void test_stream() {
        final GenomicIterator git = new GorpIterator(new FileSource(new SourceReference(gorpPath, null, tempDirPath, null, null))).filter(r -> r.isProgress);
        for (String chr : chrs) {
    ...
    public void test_seek() {
        final GenomicIterator git = new GorpIterator(new FileSource(new SourceReference(gorpPath, null, tempDirPath, null, null)));
