...
public class UTestHelpCmd {
    ...
    private static String[] INPUT = { "->COMMANDS",
            ...
            "COLSPLIT, COLTYPE, COLUMNSORT, CREATE, CSVCC, CSVSEL, DAGMAP, DEF, DISTINCT, DISTLOC, FORMULAS, GAVA, GOR, GORCMD, GORROW,",
            "GORROWS, GORSQL, GRANNO, GREP, GROUP, GTGEN, GTLD, HIDE, INSET, JOIN, LDANNO, LEFTJOIN, LEFTWHERE, LIFTOVER, LOG, MAP, MERGE,",
            "MULTIMAP, NOR, NORCMD, NORROWS, NORSQL, PARALLEL, PARTGOR, PEDPIVOT, PGOR, PILEUP, PIPESTEPS, PIVOT, PLINKREGRESSION, PREFIX,",
